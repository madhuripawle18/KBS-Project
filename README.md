...
* Hanumasri Bollepalli : Worked on Data Pre-processing, researched all the qwicklabs and reference papers to get an overview of machine learning models and working on BigQuery and evaluated the Machine Learning model and Predicting the model.Updated git repository along with read.me file. Worked on Documentation and presentation.
